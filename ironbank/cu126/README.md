# DataEval Workflows (CUDA 12.6)

DataEval Workflows container - CUDA 12.6 variant
...
| `CONTAINER_MODE` | Runtime acceleration mode (`cpu` or `gpu`) | `gpu` |
...
docker run --rm --gpus all \
  ...
  registry1.dso.mil/ironbank/dataeval/dataeval-flow-cu126:0.2.2
```

### Interactive Help

```bash
docker run --rm registry1.dso.mil/ironbank/dataeval/dataeval-flow-cu126:0.2.2 --help
```
