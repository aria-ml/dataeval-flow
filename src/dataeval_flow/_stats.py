...
def stats_policy_for(
    ...
    *,
    ...
    policy, they are what gets *checked* against it: a consumer reading a family no
    ...
    declared one against anything. Leave it unset to request the union and check that
    union.
