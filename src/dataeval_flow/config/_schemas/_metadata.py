"""Metadata policy schemas: how a run reads its metadata factors and encodes them."""
...
class RemapCorrectionConfig(_CorrectionBase):
    ...
    kind: Literal["remap"] = Field(default="remap", description="Selects this correction: `remap`.")
...
class RescaleCorrectionConfig(_CorrectionBase):
    ...
    kind: Literal["rescale"] = Field(default="rescale", description="Selects this correction: `rescale`.")
...
class ParseValueCorrectionConfig(_CorrectionBase):
    ...
    kind: Literal["parse_value"] = Field(default="parse_value", description="Selects this correction: `parse_value`.")
...
class ParseDateTimeCorrectionConfig(_CorrectionBase):
    ...
    kind: Literal["parse_datetime"] = Field(
        default="parse_datetime", description="Selects this correction: `parse_datetime`."
    )
