...
class SourceOperand:
    ...
    def view(self) -> "AnnotatedDataset[Any]":
        ...
        Build it here rather than storing it, so a never-merged source does no work:
        a `Relabel` validates the dataset the moment its view is built.
        """
...
def _label_space_record(
    ...
    from dataeval_flow._label_space import label_space_digest
    from dataeval_flow._result import LabelSpaceRecord
