"""The ``data-analysis`` workflow's config and health thresholds."""
...
__all__ = ["DataAnalysisHealthThresholds", "DataAnalysisConfig"]
...
class DataAnalysisConfig(
    ...
    type: str = Field(default="data-analysis", description="The workflow type this entry configures: `data-analysis`.")
