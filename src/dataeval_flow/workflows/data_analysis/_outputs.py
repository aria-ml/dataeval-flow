...
class DataAnalysisRawOutput(WorkflowRawOutput):
...
class DataAnalysisReport(WorkflowReport):
    """Human-readable report for data analysis workflow."""


class DataAnalysisOutput(WorkflowOutput[DataAnalysisRawOutput, DataAnalysisReport]):
...
class DataAnalysisResult(WorkflowResult[DataAnalysisMetadata, DataAnalysisOutput]):
    """The result of a ``data-analysis`` run.
