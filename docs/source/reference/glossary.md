...
MAITE
    ...
    in the JATIC ecosystem.

Outlier
    A data sample that deviates significantly from the rest of the dataset, detected
    via statistical methods such as modified z-score, z-score, or IQR.

Data Cleaning
    The process of identifying and flagging quality issues in a dataset, including
    outliers, duplicates, and label anomalies.
